/* IndoSpeed market movers share the same quote service used by Home, Markets and Stock. */
(function(){
 ...
 const cacheKey=kind=>`indospeed_home_movers_${kind}`;
 ...
 async function get(kind){
  const api=window.IndoSpeedMarket;if(!api?.getFastQuotes)throw new Error('Market quote service unavailable');
 ...
 window.IndoSpeedMovers={get,readCache};
})();