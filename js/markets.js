document.addEventListener('DOMContentLoaded',()=>{
 ...
 document.querySelectorAll('.stock-row').forEach(row=>row.addEventListener('click',()=>{const symbol=row.dataset.symbol;if(symbol){localStorage.setItem('indomark_selected_stock',symbol);location.href='stock.html';}}));
