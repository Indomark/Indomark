document.addEventListener('DOMContentLoaded',()=>{
 const symbol=(localStorage.getItem('indomark_selected_stock')||'RELIANCE').toUpperCase();
 ...
 document.getElementById('analysisBtn')?.addEventListener('click',()=>{localStorage.setItem('indomark_selected_stock',symbol);location.href='analysis.html';});
});